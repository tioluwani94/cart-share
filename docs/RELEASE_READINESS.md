...
- The owner subsequently confirmed build **1.0.0 (12)** is visible and installable in TestFlight and will test it. This resolves the processing/availability checkpoint above; acceptance of the production binary's UAT remains pending.
