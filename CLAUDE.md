...
- Use `GlassBottomSheetScrollView` for any sheet form that can approach the keyboard. It owns outside-tap pass-through, drag-to-dismiss, Gorhom integration, and automatic focused-field reveal after the keyboard takes space; do not replace or disable those defaults without a tested platform requirement.
