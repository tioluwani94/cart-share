...
describe("useNetworkStatus", () => {
  ...
  it("treats cellular service without internet as offline until reachability returns", () => {
    let latestStatus;
    let renderer;
    act(() => {
      renderer = TestRenderer.create(
    ...
    expect(latestStatus.justCameOnline).toBe(false);
    ...
    expect(latestStatus.justCameOnline).toBe(true);
    act(() => renderer.unmount());
  });
